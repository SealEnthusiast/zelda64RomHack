...
void DrawGauntletDList(PlayState* play, Player* this, s32 limbIndex) {
    ...
    Gfx* hackAdultGauntletsDLists[] = {
        gPlayasAdult_DlBracelet, 			// PLAYER_LIMB_L_HAND
    ...
    Gfx* hackChildGauntletsDLists[] = {
        gPlayasChild_DlBracelet, 			// PLAYER_LIMB_L_HAND
        gPlayasChild_DlGauntletForearmL, 	// PLAYER_LIMB_L_FOREARM
        gPlayasChild_DlGauntletForearmR,	// PLAYER_LIMB_R_FOREARM
        gPlayasChild_DlGauntletHandL,		// PLAYER_LIMB_L_HAND
        gPlayasChild_DlGauntletHandR,		// PLAYER_LIMB_R_HAND
        gPlayasChild_DlGauntletFistL,		// PLAYER_LIMB_L_HAND
        gPlayasChild_DlGauntletFistR,		// PLAYER_LIMB_R_HAND
    };
