...
#define WALLSWITCH_COLHDR 0x06001960
#define WALLSWITCH_NOGRAB_COLHDR 0x06001a44
...
void WallPullSwitch_Init(Actor* thisx, PlayState* play) {
    ...
    Actor_Spawn(&play->actorCtx, play, 0x023C, this->dyna.actor.world.pos.x,
...
void WallPullSwitch_DrawFrame(Actor* thisx, PlayState* play) {
    Gfx_DrawDListOpa(play, 0x060004f8);
}

void WallPullSwitch_Draw(Actor* thisx, PlayState* play) {
    WallPullSwitch* this = (WallPullSwitch*)thisx;

    Gfx_DrawDListOpa(play, 0x06001850);
}
...
void WallPullSwitch_PlayerPulling(WallPullSwitch* this, PlayState* play) {
    ...
    Audio_PlayActorSfx2(&this->dyna.actor, NA_SE_EV_TRAP_OBJ_SLIDE - SFX_FLAG);
